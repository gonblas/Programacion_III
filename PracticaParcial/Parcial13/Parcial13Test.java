...
public class Parcial13Test {
    ...
    Parcial13 P13 = new Parcial13();
    ListaGenerica<Ciudad> list = P13.resolver(ciudades, "Suipacha", "La Plata", 2);
    list.comenzar();
    while (!list.fin()) {
        System.out.print(" -> " + list.proximo().getNombre());
    }
    System.out.println();
    // -> Suipacha -> Carlos Keen -> Moreno -> Quilmes -> La Plata
}
}
