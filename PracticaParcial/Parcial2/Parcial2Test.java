...
public class Parcial2Test {
    public static void main(String[] args) {
        ...
        ListaGenerica<Ciudad> ciudadesObligatorias = new ListaGenericaEnlazada<Ciudad>();
        ciudadesObligatorias.agregarInicio(v3.dato());  //Quilmes 
        ciudadesObligatorias.agregarInicio(v7.dato());  //Carlos Keen

        ListaGenerica<Ciudad> l = P2.resolver(ciudades, "La Plata", "Suipacha", ciudadesObligatorias);
